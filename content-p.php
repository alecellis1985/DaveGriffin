...
<body id="page-top" class="index" data-vanleo="content">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#team">Solution</a>
                    </li>
                    */ ?>
                    <li>
                        <a class="page-scroll" href="#contact">Advertisement</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row  text-center">
                <div class="col-lg-12">
                    ...
                    <p><strong><a href="processor-p.php" class="page-scroll btn btn-xl">See if you qualify for Obama’s student loan reduction program</a></strong></p>
                </div>                
            </div>            
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><a href="processor-p.php">Get Help qualifying for Obama’s student loan reduction program</a></h2>
    ...
    <section id="team">
        <div class="container">
            ...
            <div class="row">
				<div class="col-lg-6">
					<p>Luckily there is a company who has had their lawyers go through the bill and create an easy way for normal people to take advantage of the program.  <strong><a href="processor-p.php">StudentLoanForgive.org</a></strong> was created specifically to help people through this process.</p>
                ...
                <div class="col-lg-6">
                    ...
                    <p>Contact <strong><a href="processor-p.php">StudentLoanForgive.org</a></strong> today and see how you can have a trained expert show you how to fill out the correct government paperwork to get your student loan debt reduced.</p>
				</div>
                <!--
				<div class="col-sm-6">
