...
<body id="page-top" class="index" data-vanleo="content">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="<?php echo basename(__FILE__) ?>">Student Loan Forgiveness</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="article/repayment-plans.html">Payment Plans</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="article/nurses.html">For Nurses</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="article/teachers.html">For Teachers</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="article/public-service.html">Plan Details</a>
                    </li>
					<li>
                        <a class="page-scroll" href="#">Advertorial</a>
                    </li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <h1 class="intro-heading">Obama Expands Student Loan Forgiveness Program</h1>
                <strong class="intro-lead-in">Warning: Do not pay your next student loan bill until you read this…</strong>
                <!--
                ...
                <a href="#services" class="hidden page-scroll btn btn-xl vanleo-large-text">read more</a>
    ...
    <section id="services" >
        <div class="container">
            <div class="row  text-center">
                <div class="col-lg-12">
                    <u class="section-heading">There is a new policy the US federal government has passed that your lender <strong> doesn’t want you to know about.</strong></u>
                    <hr>
                    <p>With student loan debt spiraling out of control Barack Obama has created legislation that allows millions of regular americans to have their student loans heavily reduced or cancelled completely.</p>

                    <p>The big banks have been trying to keep this under wraps for some time, but as more and more people are getting their loans heavily reduced the word is getting out. Many people are telling their friends about the financial freedom they enjoy after getting their payments slashed by 80% or in some cases having the loans cancelled all together.</p>
                    
                    <p><strong><a href="processor.php" class="page-scroll btn btn-xl">See if you qualify for Obama’s student loan reduction program</a></strong></p>
                </div>                
            </div>            
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><a href="processor.php">Get Help qualifying for Obama’s student loan reduction program</a></h2>
                    <h3 class="section-subheading text-muted">Our student loan experts are here to help</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <iframe data-vanleo-class="youtube" src="https://www.youtube.com/embed/I3vt2x_FSSs?showinfo=0&modestbranding=1&controls=0&autohide=1&allownetworking=internal" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-md-6">
                    <p>The program popularly known as Obama Student Loan Forgiveness was written into law as the “William D. Ford Federal Direct Loan Program.”  This program took effect July 1, 2010 after president Obama signed the Health Care and Education Reconciliation Act of 2010 formerly known as Public Law 111-152.</p>

                    <p>The only problem is that – as with most government legislation – the process is complicated.</p>

                    <p>Few people are able to navigate the law and find the correct paperwork to fill out.  Unless you are a lawyer who has passed the bar exam most people just stop trying.</p>

                    <p>The law itself is 55 pages long and can be found <a href="https://www.gpo.gov/fdsys/pkg/PLAW-111publ152/pdf/PLAW-111publ152.pdf"> here</a> on the government publishing office website.  As you can see on the government site there are many sections of small font written by lawyers and politicians that are very hard for normal people to understand.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="team">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Solution</h1>
                    <h3 class="section-subheading text-muted">SOLVE YOUR STUDENT LOAN PROBLEMS</h3>
                </div>
            </div>
            <div class="row">
				<div class="col-lg-6">
					<p>Luckily there is a company who has had their lawyers go through the bill and create an easy way for normal people to take advantage of the program.  <strong><a href="processor.php">StudentLoanForgive.org</a></strong> was created specifically to help people through this process.</p>

                    <p>They charge a low fee for helping people fill out the correct government forms in the correct way to get their student loans reduced.</p>

                    <p>Their service is the same as having a tax accountant help you with your taxes, but it is much cheaper.</p>

                    <p>Contact them for free today if you would like any of the following:</p>
                    
                    <ul>
                        <li>Having your student loan payment reduced by 80%.</li>
                        <li>Having your student loans cancelled entirely.</li>
                        <li>Getting Guidance from trained experts on how to fill out the right government forms.</li>
                        <li>Prevent wage garnishment.</li>
                        <li>Get yourself out of debt.</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <p>This is a program that the big banks and the fat cats on wall street don’t want you to know about.</p>
                    
                    <p>The banks just want you to pay them as much as possible so they aren’t going to show you the paperwork you need to fill out to have your loans reduced by 80% or cancelled all together.</p>

                    <p>Millions of Americans are enjoying new financial freedom because they are no longer weighted down by the burden of Student Loan Debt.</p>

                    <p>You can be one of them.</p>

                    <p>Contact <strong><a href="processor.php">StudentLoanForgive.org</a></strong> today and see how you can have a trained expert show you how to fill out the correct government paperwork to get your student loan debt reduced.</p>
				</div>
                <!--
				<div class="col-sm-6">
