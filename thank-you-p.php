...
<!--                <div class="col-xs-12 tagline text-center">WHEN LOAN FORGIVEN, YOU WIN!</div>-->
            ...
            <div class="row">
                ...
                */
                ?>
                <div class="col-xs-12 promo thank_you text-center ng-binding color-green font-weight-bold">Congratulations, You Qualify!</div>
            </div>
        </div>
    </header>
        ...
        <div class="container thank_you">
            <div class="row text-center">
                <div class="row  text-center control-label">
                    <div class="col-lg-12"><p class="van_title">Call Us To Set Up Your Loan Forgiveness Program</p></div>               
                </div>
            </div>
            <div class="row text-center">
                <div class="col-lg-12"><a class="button" href="tel:1-800-217-0422">1-800-217-0422</a></div>
            </div>
        </div>
    </section>
    <footer>
